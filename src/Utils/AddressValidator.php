...
{
	public static function isETHAddress(string $address)
	{
	...
	protected static function matchesPattern(string $address)
	{
		return preg_match('/^(0x)?[0-9a-f]{40}$/i', $address);
	}

	protected static function isAllSameCaps(string $address)
	{
